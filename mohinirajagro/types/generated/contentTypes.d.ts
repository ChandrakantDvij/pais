...
export interface ApiMainmenuMainmenu extends Struct.CollectionTypeSchema {
  collectionName: 'mainmenus';
  info: {
    displayName: 'mainmenu';
    pluralName: 'mainmenus';
    singularName: 'mainmenu';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    parent: Schema.Attribute.Relation<'oneToOne', 'api::mainmenu.mainmenu'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    paymentInfo: Schema.Attribute.Component<'ecommerce.payment-info', true>;
    paymentStatus: Schema.Attribute.Enumeration<
      ['pending', 'paid', 'failed', 'refunded']
    >;
    placedAt: Schema.Attribute.DateTime;
    products: Schema.Attribute.Component<'ecommerce.order-item', true>;
    publishedAt: Schema.Attribute.DateTime;
    shippingAddress: Schema.Attribute.Component<'ecommerce.address', true>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::mainmenu.mainmenu': ApiMainmenuMainmenu;
